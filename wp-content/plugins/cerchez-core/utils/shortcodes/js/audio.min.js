...
jQuery(document).ready(function () {
	...
	triggerCerchezAudioInit(document);
...
jQuery(document).on("cerchezWidgetUpdate", function(e) {
	...
	triggerCerchezAudioInit(e.target);
